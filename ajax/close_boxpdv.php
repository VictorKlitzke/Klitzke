...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if (!$id_boxpdv) {
            ...
            $exec = $sql->prepare("INSERT INTO box_closing (id_boxpdv, value_debit, value_credit, value_pix, value_money, date_close) 
                    VALUES (:id_boxpdv, :value_debit, :value_credit, :value_pix, :value_money, :date_close)");
