    ...
    <div class="menu">
        <div class="container-menu">
            ...
            <div id="registers" style="display: none;">
                ...
                <a <?php SelectedMenu('register-table'); ?> href="<?php echo INCLUDE_PATH; ?>register-table">Cadastrar
                    Mesa
                </a>
            ...
            <div id="invoicing" style="display: none;">
                <a <?php SelectedMenu('register-boxpdv'); ?> href="<?php echo INCLUDE_PATH; ?>register-boxpdv">Abrir
                    Caixa</a>
                <a <?php SelectedMenu('register-sales'); ?> href="<?php echo INCLUDE_PATH; ?>register-sales">Vendas</a>
                <a <?php SelectedMenu('register-request'); ?>
                    href="<?php echo INCLUDE_PATH; ?>register-request">Pedidos</a>
            </div>
            ...
            <div id="report" style="display: none;">
                <a <?php SelectedMenu('reports') ?> href="<?php echo INCLUDE_PATH; ?>reports">Relatórios diversos</a>
            </div>
