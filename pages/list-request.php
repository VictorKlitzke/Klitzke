                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="display: flex; justify-content: center; gap: 10px; margin: 6px; padding: 6px;">
                            ...
                            <div>
                                <a actionBtn="delete" class="btn-delete" href="<?php echo INCLUDE_PATH; ?>gather-tables?id=<?php echo base64_encode(
                                       $value["id"]
                                   ); ?>">Ajuntar mesas</a>
                            </div>
                            <div>
                            ...
                            <div>
                                <a actionBtn="delete" class="btn-delete" href="<?php echo INCLUDE_PATH; ?>register-request?delete=<?php echo $value[
                                       "id"
                                   ]; ?>">Deletar</a>
                            </div>
                        </td>
