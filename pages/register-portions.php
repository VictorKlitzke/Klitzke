    ...
    <div class="card-body">
      <form id="createFormPortion">
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="mb-3">
              <label for="inventaryDate" class="form-label">Quantidade de Porção</label>
              <input type="number" class="form-control border-dark" id="quantityPortion" placeholder="Quantidade de Porção">
              <span id="value-error" class="error-message">Campo está invalido, Ajuste se possivel.</span>
            </div>
          </div>
          <div class="col-md-12">
